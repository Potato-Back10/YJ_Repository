...
public class UserServiceImpl implements UserService{
    ...
    private final JwtTokenProvider jwtTokenProvider;        //토큰 제너레이터... 왜 안만들었지?
    ...
    @Override
    public LoginResponseDto login(UserRequestDto requestDto, HttpServletResponse response) {
        ...
        UserResponseDto userResponse = new UserResponseDto(user.getId(), user.getUsername());
        TokenResponseDto tokenResponse = new TokenResponseDto(accessToken, refreshToken);

        return new LoginResponseDto(userResponse, tokenResponse);
    }
